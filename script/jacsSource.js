...
//******************************************************************************
	...
	//TASKSTEP NOTICE: CSS has been moved to external style sheet "jacs.css"
     ...
     return {show: function(ele)
             ...
             make: function (calId)
                {cals.push(calId);
				 ...
				 INPUTjacsHead1.setAttribute('autocomplete','off');
				 ...
				 INPUTjacsHead4.setAttribute('autocomplete','off');
